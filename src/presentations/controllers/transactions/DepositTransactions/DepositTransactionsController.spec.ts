...
import { DTOResponseDepositTransactionsUseCase, IDepositTransactionsUseCase } from "../../../../domain/module/transactions/useCase/DepositTransactions/DepositTransactionsUseCase";
...
const makeSut = ():TypesSut =>{
	const useCaseShowMock = new class CreateUserUseCase implements IDepositTransactionsUseCase {
		execute(): Promise<DTOResponseDepositTransactionsUseCase> {

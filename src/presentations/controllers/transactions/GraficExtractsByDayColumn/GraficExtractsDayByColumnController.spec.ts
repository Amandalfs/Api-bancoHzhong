...
import { IGraficDayStatsUseCase, OutputGraficDayStatsUseCaseDTO } from "../../../../domain/module/transactions/useCase/GraficDayStats/GraficDayStatsUseCase";
...
const makeSuit = (): TypeSuit  => { 
	const useCase = new class UseCase implements IGraficDayStatsUseCase {
		async execute(): Promise<OutputGraficDayStatsUseCaseDTO> {

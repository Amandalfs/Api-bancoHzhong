...
import { DTOResponseSendingMoneyUseCase, ISendingMoneyUseCase } from "../../../../domain/module/transactions/useCase/SendingMoney/SendingMoneyUseCase";
...
const makeSut = ():TypesSut =>{
	const useCaseShowMock = new class sendingMoneyTransactionsUserUseCase implements ISendingMoneyUseCase {
		execute(): Promise<DTOResponseSendingMoneyUseCase> {

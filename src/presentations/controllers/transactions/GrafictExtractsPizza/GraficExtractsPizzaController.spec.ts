...
import { IGraficExtractsPizzaUseCase, OutputGraficExtractsPizzaDTO } from "../../../../domain/module/transactions/useCase/GraficExtractsPizza/GraficExtractsPizzaUseCase";
...
const makeSuit = (): TypeSuit =>{
	const useCase = new class GraficExtractsPizzaMock implements IGraficExtractsPizzaUseCase {
		async execute(): Promise<OutputGraficExtractsPizzaDTO> {

...
import { DTOResponseSessionsUseCase, ISessionsUsersUseCase } from "../../../../domain/module/acconts/useCase/SessionsUsers/SessionsUsersUseCase";
...
const makeSut = ():TypesSut =>{
	const useCaseSessionsMock = new class CreateUserUseCase implements ISessionsUsersUseCase {
		execute(): Promise<DTOResponseSessionsUseCase> {

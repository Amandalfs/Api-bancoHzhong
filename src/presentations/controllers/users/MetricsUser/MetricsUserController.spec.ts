...
import { IMetricsUserUseCase, OutputMetricsUserUseCaseDTO } from "../../../../domain/module/acconts/useCase/MetricsUser/MetricsUserUseCase";
...
const makeSuit = (): TypeSuit => {
	const useCase = new class UseCase implements IMetricsUserUseCase{
		async execute(): Promise<OutputMetricsUserUseCaseDTO> {

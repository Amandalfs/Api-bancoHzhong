...
import { DTOResponseCreatekeyUseCase, ICreatekeyUseCase } from "../../../../domain/module/keys/useCase/CreateKey/CreateKeyUseCase";
...
const makeSut = ():TypesSut =>{
	const useCaseCreateMock = new class CreateUseCase implements ICreatekeyUseCase {
		execute(): Promise<DTOResponseCreatekeyUseCase> {
